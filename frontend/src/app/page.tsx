...
const PLANS = [
  {
    ...
    features: ['Fotos de entrega salvas por 15 dias'],
    highlight: false,
    badge: null,
    active: true,
  },
  ...
  },
  {
    ...
    features: ['Confirmação com foto da entrega', 'Avaliação de entregadores', 'Exportação CSV com filtros', 'Fotos de entrega salvas por 3 meses'],
    highlight: false,
    badge: null,
    active: true,
  },
  {
    ...
    deliverers: 'Até 4 entregadores',
    deliveries: 'Sem limite de entregas',
    features: ['Confirmação com foto da entrega', 'Avaliação de entregadores', 'Exportação CSV com filtros', 'Notificações WhatsApp automáticas', 'Fotos de entrega salvas por 3 meses'],
    highlight: true,
    badge: 'Mais popular',
    active: false,
  },
  {
    ...
    deliveries: 'Sem limite de entregas',
    features: ['Confirmação com foto da entrega', 'Avaliação de entregadores', 'Exportação CSV com filtros', 'Notificações WhatsApp automáticas', 'Logo e cores personalizadas', 'Fotos de entrega salvas por 1 ano'],
    highlight: false,
    badge: null,
    active: true,
  },
