...
const BASE_NAV: {
  ...
  { href: '/announcements', label: 'Comunicados',  icon: Megaphone,     scope: 'announcements:manage', feature: null },
  ...
  { href: '/garantias',  label: 'Garantias',     icon: ShieldCheck,   scope: 'warranties:view',  feature: null },
